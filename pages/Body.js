...
const Body = ({ spotifyApi, chooseTrack }) => {
  ...
  // console.log(accessToken)
    ...
    useEffect(() => {
        ...
        spotifyApi.searchTracks(search, { limit: 30 }).then((res) => {
          setSearchResults(
  ...
  return (
    <section className="bg-black ml-24 py-4 space-y-8 md:max-w-6xl flex-grow md:mr2.5">
         ...
         <div className="flex gap-x-8 absolute min-w-full md:relative ml-6">
              ...
              <div className="hidden xl:inline max-w-[270px]">
                ...
                <div className="flex gap-x-2 gap-y-2.5 flex-wrap mb-2">
                  <button className="genres">Classic</button>
                  <button className="genres">House</button>
                  <button className="genres">Minimal</button>
                  <button className="genres">Hip-pop</button>
                  <button className="genres">Apala</button>
                  <button className="genres">Fuji</button>
                  <button className="genres">Chillout</button>
                  <button className="genres">Country</button>
                  <button className="genres">Blues</button>
                  <button className="genres">Afro</button>
