...
const RightBar = ({ chooseTrack, spotifyApi  }) => {
  ...
  return (
    <section className="p-4 space-y-8 pr-8">
      <div className="flex space-x-2 items-center justify-between">
        <div className="flex item-center space-x-4 border-2 border-[#262626] rounded-full h-23 py-3 px-4">
          <HiOutlineShieldCheck className="rightbaricon" />
          <MdOutlineSettings className="rightbaricon"/>
          <BiBell className="rightbaricon"/>
        </div>
        {/* Profile */}
        <Dropdown />
      </div>
